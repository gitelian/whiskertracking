...
%
% UPDATE 20180822: select ROI to count number of pulses from LED
% G. Telian
...
% n_frames2avg = 1500; % frames to average for object detection
...
n_frames2avg = str2double(usrInput{3});
...
% frames where whisker traces where within object boundary
frm = cell(length(msr_dir), 1);

% number of traces that were within the object boundary
whisk_in_frame = cell(length(msr_dir), 1);

% centroid of object boundary
center_of_boundary = cell(length(msr_dir), 1);
...
progressbar('files', 'frames', 'object_boundary')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
...
% for f_ind = good_inds
    ...
    trc = struct2table(LoadWhiskers([exp_dir filesep 'trace' filesep trc_dir(f_ind).name]));
    ...
    %% determine if whisker traces overlap with object boundary
    
    % get object boundary
    v = VideoReader(['F:\wtavi' filesep exp_name filesep avi_dir(f_ind).name]);
    img = read(v);
    [bounds, obj_frame_inds, centroid] = find_object_bounds(img, n_frames2avg, num_frames);
    
    within_frame_inds = [];
    num_traces_within_bounds = [];
    for obj_k = 1:length(obj_frame_inds)
        progressbar([], [], obj_k/length(obj_frame_inds))
        frame_k = obj_frame_inds(obj_k);
        
% %         % REMOVE
% %         imshow(read(v, frame_k))
% %         hold on
% %         plot(bounds{frame_k}(:, 2), bounds{frame_k}(:, 1), 'g', 'LineWidth', 2)
        
        % get whisker coordinates
        % get indices for data corresponding to frame k
        data_inds = find(msr.fid == frame_k-1);
        % get length of whisker traces for frame k
        wids = msr.wid(data_inds);
        len  = msr.length(data_inds);
        ind  = find(len >= prctile(len, prctle));

        % iterate through whiskers and count number of whiskers that are
        % within the object's boundary
        count = 0;
        for l = 1:length(ind)
            wid = wids(ind(l));
            trc_ind = find(table2array(trc(data_inds, 'id')) == wid);
            x = trc.x{data_inds(trc_ind)};
            y = trc.y{data_inds(trc_ind)};
            
            [in, on] = inpolygon(x, y, bounds{frame_k}(:, 2), bounds{frame_k}(:, 1));
            num_points_within = sum([numel(x(in)), numel(y(in))]);
...
%                 pause(0.1)
        ...
        if count > 0
            within_frame_inds = [within_frame_inds; frame_k];
            num_traces_within_bounds = [num_traces_within_bounds; count];
        end                            
    end
    ...
    if LED
        ...
        threshold = mean(light_signal) + 3*std(light_signal);
    ...
    % record frame indices where whisker traces were within the object
    % boundary
    frm{f_ind} = within_frame_inds;
    
    % number of whisker traces within bounds of object
    whisk_in_frame{f_ind} = num_traces_within_bounds;
    
    % centroid of object boundary
    center_of_boundary{f_ind} = centroid;
...
if LED
    save([exp_dir filesep fname '-wt.mat'],...
        ...
        'face', 'frm', 'whisk_in_frame', 'center_of_boundary', 'pulse_sequence', '-v7.3')
else
    save([exp_dir filesep fname '-wt.mat'],...
        'angle_notsmooth', 'ang', 'phs', 'sp', 'amp', 'vel', 'wsk', 'cur',...
        'face', 'frm', 'whisk_in_frame', 'center_of_boundary', '-v7.3')
end
